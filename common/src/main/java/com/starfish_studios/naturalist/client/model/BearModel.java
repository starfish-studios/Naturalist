...
public class BearModel extends GeoModel<Bear> {
    @Override
    public ResourceLocation getModelResource(Bear bear, @Nullable GeoRenderer<Bear> geoRenderer) {
        return ResourceLocation.fromNamespaceAndPath(Naturalist.MOD_ID, "geo/entity/bear.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(Bear bear, @Nullable GeoRenderer<Bear> geoRenderer) {
        // BEHAVIOR TEXTURES
