...
public class AlligatorModel extends GeoModel<Alligator> {
    ...
    @Override
    public ResourceLocation getModelResource(Alligator alligator, @Nullable GeoRenderer<Alligator> geoRenderer) {
        return ResourceLocation.fromNamespaceAndPath(Naturalist.MOD_ID, "geo/entity/alligator.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(Alligator alligator, @Nullable GeoRenderer<Alligator> geoRenderer) {
