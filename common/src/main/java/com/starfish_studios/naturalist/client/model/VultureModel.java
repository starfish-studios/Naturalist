...
public class VultureModel extends GeoModel<Vulture> {
    @Override
    public ResourceLocation getModelResource(Vulture vulture, @Nullable GeoRenderer<Vulture> geoRenderer) {
        return ResourceLocation.fromNamespaceAndPath(Naturalist.MOD_ID, "geo/entity/vulture.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(Vulture vulture, @Nullable GeoRenderer<Vulture> geoRenderer) {
