...
public class Alligator extends Animal implements NaturalistGeoEntity, EggLayingAnimal {
    ...
    public AgeableMob getBreedOffspring(@NotNull ServerLevel level, @NotNull AgeableMob otherParent) {
        return NaturalistEntityTypes.ALLIGATOR.create(level, EntitySpawnReason.BREEDING);
    }
    ...
    protected void registerGoals() {
        ...
        this.targetSelector.addGoal(1, new NearestAttackableTargetGoal<>(this, LivingEntity.class, 10, true, false, (entity, level) -> {
            ...
            for (BlockPos pos : list) {
                if (level().getBlockState(pos).is(NaturalistRegistry.ALLIGATOR_EGG)) {
    ...
    public boolean isFood(@NotNull ItemStack stack) {
        return stack.is(NaturalistTags.ItemTags.ALLIGATOR_FOOD_ITEMS);
    }
    ...
    public Block getEggBlock() {
        return NaturalistRegistry.ALLIGATOR_EGG;
    }
    ...
    protected <E extends Alligator> PlayState predicate(final AnimationState<E> event) {
     ...
     protected <E extends Alligator> PlayState attackPredicate(final software.bernie.geckolib.animation.AnimationState<E> event) {
