...
public class NoFluidMobBucketWithVariantsItem extends NoFluidMobBucketItem {
    ...
    public NoFluidMobBucketWithVariantsItem(Supplier<? extends EntityType<?>> entitySupplier, Fluid fluid, SoundEvent emptyingSound, int color, Item.Properties settings) {
