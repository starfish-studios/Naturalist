...
public class DragonflyRenderer extends GeoEntityRenderer<Dragonfly, NaturalistGeoRenderState> {
    ...
    @Override
    public void extractRenderState(Dragonfly entity, NaturalistGeoRenderState state, float partialTick) {
    ...
    public RenderType getRenderType(Dragonfly entity, float partialTicks, PoseStack stack,
    ...
    @Override
    public NaturalistGeoRenderState createRenderState(Dragonfly entity, Void unused) {
