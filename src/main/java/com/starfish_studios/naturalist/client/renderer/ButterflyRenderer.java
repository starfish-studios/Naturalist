...
public class ButterflyRenderer extends GeoEntityRenderer<Butterfly, NaturalistGeoRenderState> {
    ...
    @Override
    public void extractRenderState(Butterfly entity, NaturalistGeoRenderState state, float partialTick) {
    ...
    public @NotNull RenderType getRenderType(Butterfly entity, float partialTicks, PoseStack stack,
    ...
    @Override
    public NaturalistGeoRenderState createRenderState(Butterfly entity, Void unused) {
