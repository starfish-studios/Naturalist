...
public class NaturalistFabric implements ModInitializer {
    ...
    void registerBrewingRecipes() {
        FabricBrewingRecipeRegistryBuilder.BUILD.register(builder -> {
            var forestDasher = BuiltInRegistries.POTION.wrapAsHolder(NaturalistPotions.FOREST_DASHER.get());
            var longForestDasher = BuiltInRegistries.POTION.wrapAsHolder(NaturalistPotions.LONG_FOREST_DASHER.get());
            var strongForestDasher = BuiltInRegistries.POTION.wrapAsHolder(NaturalistPotions.STRONG_FOREST_DASHER.get());
            builder.addMix(Potions.AWKWARD, NaturalistRegistry.ANTLER.get(), forestDasher);
            builder.addMix(forestDasher, Items.REDSTONE, longForestDasher);
            builder.addMix(forestDasher, Items.GLOWSTONE_DUST, strongForestDasher);
        });
    }
    ...
    void addSpawns() {
        ...
        addMobSpawn(NaturalistTags.Biomes.HAS_ZEBRA, MobCategory.CREATURE, NaturalistEntityTypes.ZEBRA.get(), NaturalistConfig.zebraSpawnWeight, 2, 3);
        ...
        addMobSpawn(NaturalistTags.Biomes.HAS_DRAGONFLY, MobCategory.AMBIENT, NaturalistEntityTypes.DRAGONFLY.get(), NaturalistConfig.dragonflySpawnWeight, 2, 3);
