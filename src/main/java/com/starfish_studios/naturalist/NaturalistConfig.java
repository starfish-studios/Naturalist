...
public class NaturalistConfig extends MidnightConfig {
    ...
    @Entry(category = "mobRemoval") public static boolean removeSwampFarmAnimals = false;
    @Entry(category = "mobRemoval") public static boolean removeSavannaFarmAnimals = false;
