...
public class NaturalistTags {
    ...
    public static class Biomes {
        ...
        public static final TagKey<Biome> REMOVE_SWAMP_FARM_ANIMALS = tag("remove_swamp_farm_animals");
        public static final TagKey<Biome> REMOVE_SAVANNA_FARM_ANIMALS = tag("remove_savanna_farm_animals");
